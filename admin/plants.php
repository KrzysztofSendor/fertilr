...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-offset-1 col-md-10 col-sm-12">
				...
				<div class="row">
					<form name="EditElement" action="editPlant.php" method="post">
						<div class="col-md-8 col-sm-12">				
							<div class="panel panel-default">
								<div class="panel-heading">Lista roślin</div>
								<?php
								if(!isset($_GET['p']) || !is_numeric($_GET['p'])){
									...
									$sql = mysql_query("SELECT id_rosliny, nazwa FROM `Rosliny` LIMIT $page, 10");
								...
								<div class="modal-content">
									<div class="modal-body">
										<div class="alert alert-danger" role="alert">
											<strong>Uwaga!</strong> Usunięcie rośliny może spowodować nieodwracalne błędy.
										</div>
										Na pewno chcesz usunąć wybraną roślinę?
									</div>
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModal" aria-hidden="true">
		<div class="modal-dialog modal-sm">
			<form name="add" action="editPlant.php" method="post">
				<div class="modal-content">
					<div class="modal-body">
	...
	<form name="formEdit" action="editPlant.php" method="post">
